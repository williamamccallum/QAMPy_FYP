...
if __name__ == "__main__":
    ...
    sig = signals.SignalQAMGrayCoded(M, N, fb=fb, nmodes=nmodes)    # generates initial signal at baud rate
    sig = sig.resample(fs, beta=0.1)    # resamples signal to AWG sampling frequency
